...
- (void)userNotificationCenter:(UNUserNotificationCenter *)center
	...
	// NSURL *attachmentURL = [NSURL URLWithString:@"https://i.kym-cdn.com/entries/icons/original/000/026/489/crying.jpg"];
	...
	NSLog(@"FirebasePlugin - notification %@",notification);
	
	NSDictionary *mutableUserInfo = [notification.request.content.userInfo mutableCopy];
	
	if(mutableUserInfo != nil){
		NSLog(@"FirebasePlugin - mutableUserInfo %@",mutableUserInfo);
        NSMutableDictionary* message = [NSMutableDictionary dictionaryWithCapacity:4];
        NSMutableDictionary* additionalData = [NSMutableDictionary dictionaryWithCapacity:4];


        for (id key in mutableUserInfo) {
          ...
          withCompletionHandler:(void (^)(void))completionHandler
{
	...
	NSLog(@"FirebasePlugin - response %@",response);
